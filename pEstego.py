...
zip_file_path = '/home/luken/UNI/ISSKS/1 Laborategia - Zifraketa I/1 Laborategia -  Zifraketa I-20230921/irudia.zip'
with zipfile.ZipFile(zip_file_path, 'r') as archive:
	...
	# Calculate the hash for each file in the archive
		...
		if "e5ed313192776744b9b93b1320b5e268" == file_hash:
			...
			archive.extract(file_info, "/home/luken/UNI/ISSKS/1 Laborategia - Zifraketa I/JpgZuzenak")
